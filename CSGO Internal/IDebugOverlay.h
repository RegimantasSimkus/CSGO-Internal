...
//	virtual void AddBoxOverlay(const Vector& origin, const Vector& mins, const Vector& max, void* const& angles, int r, int g, int b, int a, float duration) = 0;
//	virtual void AddSphereOverlay(const Vector& vOrigin, float flRadius, int nTheta, int nPhi, int r, int g, int b, int a, float flDuration) = 0;
//	virtual void AddSweptBoxOverlay(const Vector& start, const Vector& end, const Vector& mins, const Vector& max, const void*& angles, int r, int g, int b, int a, float flDuration) = 0;
...
//	virtual void AddTextOverlayRGB(const Vector& origin, int line_offset, float flDuration, int r, int g, int b, int alpha, const char* format, ...) = 0;
...
//	virtual virtual void ClearDeadOverlays(void) = 0;
//	virtual virtual void ClearAllOverlays() = 0;
//	virtual void AddLineOverlayAlpha(const Vector& origin, const Vector& dest, int r, int g, int b, int a, bool noDepthTest, float duration) = 0;
//	virtual void AddBoxOverlay2(const Vector& origin, const Vector& mins, const Vector& maxs, void* const& orientation, const void*& faceColor, const void*& edgeColor, float duration) = 0;
